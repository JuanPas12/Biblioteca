...
<center>
   <br>
    ...
    <br>
    <br>
    <h1><font color = "#fff">Alta Categoria</font></h1>
	<form action="GuardaCategoria.php" method="GET">
		<table border="0">
			<tr>
				<td><font color = "#fff">Nombre Categoria</font></td>
				<td valign ="top"><input type="text" class = "caja" name="txtNombreCategoria" placeholder="Por ejemplo: Historia" required></td>
			</tr>
			<tr></tr>
			<tr></tr>
			<tr></tr>
